...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/android-device-names/1.0.5/android-device-names-1.0.5.aar) or grab via Gradle:
