...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/android-device-names/1.1.9/android-device-names-1.1.9.aar) or grab via Gradle:

```groovy
compile 'com.jaredrummler:android-device-names:1.1.9'
```
