...
class MethodGenerator(private val devices: List<Device>, private val file: File = File("method.tmp")) {
  ...
  private fun create(): String {
    ...
    for ((key, deviceList) in manufacturers) {
      ...
      Collections.sort(deviceList) { o1, o2 -> o1.marketName.compareTo(o2.marketName, ignoreCase = true) }
